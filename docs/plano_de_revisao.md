...
| | Capítulos |
|---|---|
| Reprovados em portão duro (< 600 palavras ou traço violado) | ~~55~~ → **54** |
| Aprovados, mas abaixo do alvo de 1.100 palavras | 103 |
| No padrão | ~~72~~ → **80** |
| **Total** | **234** |

**Progresso:** nota média de 8,2 → **8,3**. Revisados: caps. 47 e 41. Escritos sob a régua: 218–232.

O problema não está espalhado: **está concentrado no arco do Dilúvio**, capítulos 18–60. É ali que a obra vira sinopse — cenas de 300 palavras resolvendo eventos que deveriam ser set pieces.
...
## 🔴 Reprovados — prioridade máxima (55)
...
O maior bolsão. Tratar em ordem, com a régua na mão.

### Bloco C — isolados

Capítulos abaixo de 600 palavras fora dos blocos acima.

---

## 🟡 Curtos — segunda onda (103)

Passam nos portões mas ficam abaixo de 1.100 palavras. Entram na fila depois dos Blocos A e B. Muitos resolvem sozinhos quando os vizinhos crescerem e absorverem cena.

## 🟢 No padrão (72)

Não mexer, exceto se o arco ao redor mudar. Inclui os capítulos 218–228, escritos já sob a régua.

---

## Como saber que acabou

1. `scripts/quality_gate.py` sai com **zero reprovados em portão duro**.
2. `scripts/analyze_coherence.py` sai com **"Coerência validada"**.
3. `pytest` passa, exceto a falha ambiental conhecida do `pydub`.
4. A nota média sobe de **8,2** para **9,0**.
