...
gantt
    ...
    Kael, o Cirurgião (caído XIII)       :done, 4, 72
    Silas Vance (drenado XIV)            :done, 76, 114
    Inspetor Rangel (morto 153)          :done, 2, 153
```
...
```mermaid
flowchart TD
    A["<b>Cap. 22</b><br/>O cérebro do pai é a CPU"] --> A1["Reinterpreta caps 1-21:<br/>o vilão que perseguia Gabo<br/>era o pai gritando por socorro"]
    B["<b>Cap. 112</b><br/>Aria era a filha de verdade"] --> B1["Reinterpreta caps 2-111:<br/>a IA que acompanha Gabo<br/>é a criança que ele não enterrou"]
    C["<b>Cap. 220</b><br/>A fita de admissão"] --> C1["Reinterpreta o livro inteiro:<br/>Dante colaborou de propósito<br/>para deixar a máquina derrotável"]
    A1 --> B
    B1 --> C
    C1 --> D["<b>Cap. 227</b><br/>A rubrica em 47.311 fichas:<br/>o vilão nunca sujou a mão,<br/>mas nunca delegou o carimbo"]
```
...
```mermaid
flowchart LR
    K["<b>VIKTOR KRELL</b><br/>o autor de tudo"]
    K -->|"ligou a máquina"| G["O Gamemaster<br/>Partes II-IV"]
    K -->|"deixou solto"| T["O Taxidermista<br/>Partes VII e XVI"]
    K -->|"vendeu a tecnologia"| S["Silas Vance<br/>Partes IX-XIII"]
    K -->|"comprou a dívida"| M["Roberto Miranda<br/>Partes I-XIV"]
    K -->|"deixou os restos"| MA["Marco Moretti<br/>Parte XV+"]
    K -->|"usou como matéria-prima"| D["Dante Moretti<br/>a tragédia, não o vilão"]
    K -.->|"contratou e foi denunciado por"| E["Dra. Elara Vance<br/>antagonista intelectual"]
```
